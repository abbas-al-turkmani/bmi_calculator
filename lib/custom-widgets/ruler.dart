  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          height: widget.rulerHeight * 0.15,
        ),
        RulerPicker(
          rulerBackgroundColor: theme.cardColor,
          beginValue: widget.beginValue,
          endValue: widget.endValue,
          width: widget.rulerWidth,
          height: widget.rulerHeight * 0.7,
          initValue: widget.defultValue,
          ...
          scaleLineStyleList: [
            ScaleLineStyle(
              color: textColor,
              width: 3,
              height: widget.rulerHeight * 0.5,
              scale: 0,
            ),
            ScaleLineStyle(
              color: textColor,
              width: 1,
              height: widget.rulerHeight * 0.25,
              scale: 5,
            ),
            ScaleLineStyle(
              color: textColor,
